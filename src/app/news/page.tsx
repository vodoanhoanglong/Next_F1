    ...
    <div className="news">
      <div className="news__intro common-background">
        <div className="news__intro-header">
          ...
          <br />
          <p>
            Để tìm thông tin về hoá chất mới, bạn có thể sử dụng các công cụ tìm kiếm trực tuyến, cơ sở dữ liệu khoa học
            như PubMed, Scopus hoặc Web of Science, cũng như tham khảo các tạp chí khoa học chuyên ngành. Việc tiếp tục
            theo dõi các phát triển trong lĩnh vực này có thể giúp bạn nắm bắt cơ hội mới và đóng góp vào sự phát triển
            của ngành hóa học và công nghệ.
          </p>
        </div>
        <Image
